...
\item \emph{\requirement{req:download}{Single click installer};}\\
...
\item \emph{\requirement{req:codecs}{Support as many multimedia codecs and file formats as Tribler};}\\
...
\item \emph{\requirement{req:dispersy}{Dispersy support};}\\
...
\item \emph{\requirement{req:libswift}{Libswift support};}\\
The prototype will support the Libswift transport protocol for its P2P communication.

\item \emph{\requirement{req:anonymous}{Anonymous tunneling/Subset of Tor protocol};}\\
