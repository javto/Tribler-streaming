...
\input{contents/poa/planofaction.main.tex}		%report
\input{contents/orientation/orientation.main.tex}	%report

\includepdf[pages=-]{pdf/requirements.pdf}				%report
\includepdf[pages=-]{pdf/testandimplementationplan.pdf}	%report
