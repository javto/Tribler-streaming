...
\input{contents/ad/architecturaldesign.main.tex}			%part
...
\input{appendices/build_instructions_VLC.tex}			%build instruction
\input{appendices/build_instructions_libtorrent.tex}		%build instruction
\input{appendices/main.tex}							%meeting minutes
\input{appendices/work_division.tex}					%work division
\end{appendices}
\end{document}
