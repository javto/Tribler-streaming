...
\item \requirement{req:play}{Play the selected video};\\
...
\item \requirement{req:pause}{Pause the video};\\
...
\item \requirement{req:seek}{Seek in the video};\\
...
\item \requirement{req:download}{Download the selected video};\\
...
\item \requirement{req:channel}{Browse through 'channels' for videos};\\
...
\item \requirement{req:seed}{Seed a video};\\
...
\item \requirement{req:upload}{Upload a video};\\
While playing the video, the user can press a pause button which will pause the video. The video can then be resumed by pressing the play button.

\item \requirement{req:platform}{Make the application available for other mobile platforms};\\
