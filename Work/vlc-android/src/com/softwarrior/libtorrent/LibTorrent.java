...
/**
 * @author jaap
 *	Wrapper class for Libtorrent JNI
 */
...
//	private LibTorrent(){};
    ...
    */
    ...
    public native long GetProgressSize(String ContentFile);    
  	 ...
  	 * @param SavePath path to save torrent
  	 * @param StorageMode see addTorrent
  	 * @param MagnetLink the magnetlink to make the torrent from
  	 * returns string of filename
  	 */
    public native String MakeTorrentFromMagnet(String SavePath, int StorageMode, String MagnetLink);    
}
