...
public class MainActivity extends SherlockFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (OLD_VLC) {
			...
			View v_main = LayoutInflater.from(this)
					.inflate(R.layout.main, null);
			mMenu.setContent(v_main);

			View sidebar = LayoutInflater.from(this).inflate(R.layout.sidebar,
					null);
			...
			mInfoProgress = (ProgressBar) v_main
					.findViewById(R.id.info_progress);
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					 ...
					 * activating an old backstack, when a user hits the back
					 * button to quit
					 */
					...
					// HACK ALERT: Set underlying audio browser to be invisible
					// too.
	...
	private void ShowFragment(String tag,
		...
		try {
			...
			Log.e(TAG, "Failed to instantiate " + fragmentClass.getName()
					+ ", ShowFragment(" + tag + ") aborted.");
